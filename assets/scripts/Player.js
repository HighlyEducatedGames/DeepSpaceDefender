class Player {
    ...
    update(deltaTime) {
        // Rotate player
        if (this.pressed('ArrowLeft') && !this.pressed('ArrowRight')) this.rotation -= this.rotationSpeed * deltaTime / 1000;
        if (this.pressed('ArrowRight') && !this.pressed('ArrowLeft')) this.rotation += this.rotationSpeed * deltaTime / 1000;
